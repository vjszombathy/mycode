...
def main():
    ...
    # Disable the crayons package
    crayons.disable() # disables the crayons package
    print("The next line will be in white, because the crayons package is currently disabled")
    print('{} white {}'.format(crayons.red('red'), crayons.blue('blue')))


    # Enable the crayons package
    ...
    # print 'Victoria Hill . . . in magenta' in magenta
    print(crayons.magenta('Victoria Hill . . .  in magenta', bold=True))

    # print 'Victoria Hill . . . in yellow' in yellow
    print(crayons.yellow('Victoria Hill . . . in yellow', bold=True))
